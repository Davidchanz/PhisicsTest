...
public class Main extends JFrame{
    ...
    Main(){
        ...
        up = new Force(new Vector2(0, 1), ball.mass * 2 * ball.g, "up");
        forward = new Force(new Vector2(1, 0), ball.mass * 2 * ball.g, "forward");
        backward = new Force(new Vector2(-1, 0), ball.mass * 2 * ball.g, "backward");
    ...
    public void start(){
        ...
        Force go = new Force(new Vector2(1, 3), 100, "go");
        //ball.addForce(go);
        for(;;) {
